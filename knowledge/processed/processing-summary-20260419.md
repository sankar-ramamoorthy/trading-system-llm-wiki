...
The final 2026-04-20 README update sharpened the public framing: Milestone 1 is a manual discipline and journaling tool, not an execution bot. It emphasizes separation of intent, execution, outcome, and reflection; durable local persistence such as SQLite or similar as a likely next step; `OrderIntent`; basic P&L; querying; read-only market context; later broker adapters; and review enhancements.
